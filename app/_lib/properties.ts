...
export const allProperties: Property[] = [
  ...
  },
  {
    ...
    price: "BDT 5.1 Cr",
    monthlyPrice: "BDT 210,000/mo",
    image: propertyImages.lobby,
    tag: "Exclusive",
    beds: 4,
    baths: 5,
    area: "3,600 sq ft",
  ...
  {
    id: 7,
    title: "Skyline apartment with private balcony",
    location: "Mohakhali DOHS",
    price: "BDT 2.4 Cr",
    monthlyPrice: "BDT 89,000/mo",
  ...
  {
    id: 8,
    title: "Calm two-bedroom home near the park",
    location: "Uttara Sector 7",
    price: "BDT 1.6 Cr",
    monthlyPrice: "BDT 62,000/mo",
