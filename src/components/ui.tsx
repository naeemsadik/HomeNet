...
const styles = StyleSheet.create({
  ...
  selectWrap: { minHeight: 46, justifyContent: "center", overflow: "hidden" },
  selectButton: { minWidth: 0, flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 6, paddingHorizontal: 12 },
