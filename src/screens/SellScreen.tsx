...
const styles = StyleSheet.create({
  ...
  stats: { flex: 1, flexDirection: "row", gap: 12 },
  statsPhone: { flexDirection: "column" },
  statCard: { minHeight: 130, flex: 1, justifyContent: "center", padding: 18, borderRadius: 14, backgroundColor: "rgba(255,255,255,0.85)", borderWidth: 1, borderColor: "rgba(255,255,255,0.9)" },
  statCardPhone: { minHeight: 95 },
  statLabel: { color: colors.ink, fontFamily: fonts.semiBold, fontSize: 13 },
  statValue: { marginTop: 8, marginBottom: 6, color: colors.greenDark, fontFamily: fonts.extraBold, fontSize: 24, letterSpacing: -0.8 },
