...
const styles = StyleSheet.create({
  ...
  switchLink: { minHeight: 41, justifyContent: "center", paddingHorizontal: 17, borderRadius: 999, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.line },
  switchLinkPhone: { minHeight: 0, paddingHorizontal: 0, borderWidth: 0 },
  switchLinkText: { color: colors.green, fontFamily: fonts.extraBold, fontSize: 10 },
  ...
  typePicker: { flex: 1 },
  searchAction: { minWidth: 112, borderRadius: 999 },
  searchActionPhone: { minHeight: 43 },
  toolbar: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 25, marginBottom: 14 },
  resultCount: { color: colors.ink, fontFamily: fonts.extraBold, fontSize: 13 },
  resultHint: { marginTop: 3, color: colors.muted, fontFamily: fonts.regular, fontSize: 8 },
  toolbarActions: { flexDirection: "row", gap: 8 },
  mobileFilterButton: { minHeight: 38, flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 10, borderRadius: 9, backgroundColor: colors.soft, borderWidth: 1, borderColor: colors.line },
  mobileFilterText: { color: colors.muted, fontFamily: fonts.extraBold, fontSize: 9 },
  ...
  viewButton: { width: 31, height: 31, alignItems: "center", justifyContent: "center", borderRadius: 6 },
  viewButtonActive: { backgroundColor: colors.white },
  browseLayout: { flexDirection: "row", gap: 20, alignItems: "flex-start" },
  filterColumn: { width: 218 },
  filterPanel: { padding: 17, borderRadius: 15, backgroundColor: "#FBFDFC", borderWidth: 1, borderColor: colors.line },
  filterPanelModal: { flex: 1, padding: 22, borderRadius: 0, borderWidth: 0 },
  filterHeading: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingBottom: 13, borderBottomWidth: 1, borderBottomColor: colors.line },
  filterHeadingText: { color: colors.ink, fontFamily: fonts.extraBold, fontSize: 11 },
  filterGroup: { paddingVertical: 17, borderBottomWidth: 1, borderBottomColor: colors.line },
  filterLabel: { marginBottom: 10, color: "#53675E", fontFamily: fonts.extraBold, fontSize: 9 },
  optionRow: { flexDirection: "row", gap: 4 },
  optionButton: { minWidth: 31, height: 30, alignItems: "center", justifyContent: "center", paddingHorizontal: 7, borderRadius: 7, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.line },
  optionButtonActive: { backgroundColor: colors.green, borderColor: colors.green },
  optionText: { color: colors.muted, fontFamily: fonts.regular, fontSize: 8 },
  optionTextActive: { color: colors.white, fontFamily: fonts.bold },
  priceInputs: { flexDirection: "row", gap: 6 },
  priceField: { flex: 1, gap: 4 },
  priceCaption: { color: "#89958F", fontFamily: fonts.regular, fontSize: 7 },
  priceInput: { width: "100%", height: 34, paddingHorizontal: 7, color: colors.ink, fontFamily: fonts.regular, fontSize: 7, borderRadius: 7, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.line },
  checkList: { gap: 9 },
  checkRow: { flexDirection: "row", alignItems: "center", gap: 7 },
  checkbox: { width: 17, height: 17, alignItems: "center", justifyContent: "center", borderRadius: 5, backgroundColor: colors.white, borderWidth: 1, borderColor: "#CDDAD4" },
  checkboxActive: { backgroundColor: colors.green, borderColor: colors.green },
  checkLabel: { color: "#60736A", fontFamily: fonts.regular, fontSize: 8 },
  resetButton: { width: "100%", marginTop: 14, padding: 7, alignItems: "center" },
  resetText: { color: colors.green, fontFamily: fonts.extraBold, fontSize: 8 },
