...
const styles = StyleSheet.create({
  ...
  amenityText: { color: "#53675E", fontFamily: fonts.regular, fontSize: 13 },
  ...
  inquiryCopy: { marginTop: 7, marginBottom: 15, color: colors.muted, fontFamily: fonts.regular, fontSize: 13, lineHeight: 18 },
  form: { gap: 12 },
  formGroup: { gap: 6 },
  formLabel: { color: "#52675E", fontFamily: fonts.extraBold, fontSize: 13 },
  formInput: { width: "100%", minHeight: 46, paddingHorizontal: 14, paddingVertical: 10, color: colors.ink, fontFamily: fonts.regular, fontSize: 14, borderRadius: 10, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.line },
  messageInput: { minHeight: 90, textAlignVertical: "top" },
  inquiryButton: { width: "100%", minHeight: 48, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, borderRadius: 999, backgroundColor: colors.green },
  inquiryButtonText: { color: colors.white, fontFamily: fonts.extraBold, fontSize: 14 },
  success: { flexDirection: "row", alignItems: "flex-start", gap: 6, marginTop: 10, padding: 12, borderRadius: 8, backgroundColor: colors.greenLight },
  successText: { flex: 1, color: colors.greenDark, fontFamily: fonts.regular, fontSize: 13, lineHeight: 18 },
  ...
  scheduleText: { color: colors.green, fontFamily: fonts.extraBold, fontSize: 13 },
  similarSection: { marginTop: 54 },
  backLink: { alignSelf: "flex-start", flexDirection: "row", alignItems: "center", gap: 5, marginTop: 30 },
  backLinkText: { color: colors.green, fontFamily: fonts.extraBold, fontSize: 13 },
});
