        ...
        >
          ...
          >
            <View style={styles.heroContentLeft}>
              ...
              <Text style={styles.heroTitle}>Abrar Fuad</Text>
              <Text style={styles.heroDescription}>
                Your listings got <Text style={styles.boldSpan}>3,240 views</Text> this week and{" "}
                <Text style={styles.boldSpan}>18 new inquiries</Text>. Keep the momentum going.
              </Text>
